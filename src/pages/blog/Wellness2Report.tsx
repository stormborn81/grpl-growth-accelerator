...
const StatCallout = ({ stat, source, className = "" }: { stat: string; source: string; className?: string }) => (
  <div className={`my-8 md:my-10 py-6 md:py-8 border-t border-b border-white/10 ${className}`}>
...
const PullQuote = ({ children }: { children: React.ReactNode }) => (
  <blockquote className="my-8 md:my-10 pl-6 md:pl-8 border-l-2 border-accent">
    <p className="text-lg md:text-xl lg:text-2xl font-light italic text-white/90 leading-relaxed">{children}</p>
  </blockquote>
);

const SectionDivider = () => <div className="w-16 h-px bg-accent/40 my-10 md:my-14" />;
  ...
  const jsonLd = [
    {
      ...
      description: "GRPL's inaugural insight report mapping 8 forces reshaping the $6.8 trillion health economy, from AI and GLP-1s to telehealth, longevity, and more.",
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <section id="intro" className="py-12 md:py-16">
            <p className="text-lg md:text-xl text-white/80 font-light leading-relaxed mb-6">
              It's 6:14am. Your Whoop vibrates with a recovery score of 43%. HRV tanked. The AI coaching layer, trained on 8 years of biometric data from hundreds of thousands of users, recommends skipping your usual strength session for a 30-minute zone 2 walk and a sauna. You check your CGM and yesterday's dinner spiked your glucose higher than expected. Your telehealth app pings: blood panel results are in, ordered three days ago without leaving your couch. Your peptide protocol from the longevity clinic arrives at 9am.
            </p>
            <p className="text-lg md:text-xl text-white/80 font-light leading-relaxed mb-6">
          ...
          {/* ===== SECTION 1: AI COACH ===== */}
          <section id="ai-coach" className="py-12 md:py-16">
          ...
          {/* ===== SECTION 2: GLP-1s ===== */}
          <section id="glp1-peptides" className="py-12 md:py-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 leading-tight">
              GLP-1s Changed the Rules. Peptides Will Break Them.
            </h2>

            <StatCallout
              stat="$30+ BILLION in global GLP-1 revenue in 2025. The fastest-growing drugs in pharmaceutical history."
          ...
          <section id="telehealth" className="py-12 md:py-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 leading-tight">
            ...
            <p className="text-lg text-white/80 font-light leading-relaxed mb-6">
              The tension is convenience versus continuity. Your three app doctors don't talk to each other. Your telehealth prescriber doesn't know about your in-person physio. Your mental health app doesn't share data with your GP. The fragments multiply.
            </p>
            ...
            <p className="text-lg text-white/80 font-light leading-relaxed">
              The endgame is one ecosystem for your health data, not seven fragments. The company that integrates medical records, wearable data, mental health, prescriptions, and pathology into a single consumer health layer will build one of the most valuable businesses of the decade.
            </p>
          </section>

          {/* ===== SECTION 4: SPACES ===== */}
          <section id="spaces" className="py-12 md:py-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 leading-tight">
          ...
          {/* ===== SECTION 5: LONGEVITY ===== */}
          <section id="longevity" className="py-12 md:py-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 leading-tight">
          ...
          {/* ===== SECTION 6: OVERLAND ===== */}
          <section id="overland" className="py-12 md:py-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 leading-tight">
          ...
          <section id="mental-health" className="py-12 md:py-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 leading-tight">
          ...
          {/* ===== SECTION 8: MONEY ===== */}
          <section id="money" className="py-12 md:py-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight mb-4 leading-tight">
            ...
            <div className="mb-10">
              ...
              <div className="space-y-5">
                {[
                  { category: "AI in Healthcare", stat: "$20.9B to $148.4B by 2029", impact: "Your first health interaction will be with a machine." },
                  ...
                  { category: "Longevity Market", stat: "$610B to $1T+ by 2030", impact: "Prevention replaces treatment as the growth driver." },
          ...
          {/* ===== CLOSING ===== */}
          <section id="closing" className="py-12 md:py-16 text-center">
          ...
          {/* ===== SOURCES ===== */}
          <section id="sources" className="py-12 md:py-16 border-t border-white/10">
            ...
            <ol className="space-y-2 text-sm text-white/50 font-light list-decimal pl-6">
              ...
              <li>MarketsandMarkets, AI in Healthcare Market Report ($20.9B to $148.4B)</li>
              ...
              <li>Grand View Research, Global peptide therapeutics market ($49.5B to $93.3B)</li>
              ...
              <li>Bank of America, The Silver Dollar: Longevity Revolution ($610B to $1T)</li>
              <li>Fortune Business Insights, CGM market ($8.7B to $16.4B)</li>
              ...
              <li>Grand View Research, Mental health apps market ($6.2B to $17.5B)</li>
